...
public static class RegisterQueryCommandHandlers
{
    public static IServiceCollection AddQueryCommandHandlers(this IServiceCollection services)
    {
        ...
        // services.AddScoped<ICommandHandler<AddDepartmentCommand, Guid>, AddDepartmentCommandHandler>();
        // services.AddScoped<IQueryHandler<object, IEnumerable<DepartmentDto>>, GetDepartmentsQueryHandler>();
        // #endregion
        //
