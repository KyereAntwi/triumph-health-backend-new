...
public record AddTenantAnnouncementCommand(
    string Message,
...
public class AddTenantAnnouncementCommandValidator : AbstractValidator<AddTenantAnnouncementCommand>
{
    public AddTenantAnnouncementCommandValidator()
    {
        RuleFor(x => x.Message)
            .NotEmpty()
