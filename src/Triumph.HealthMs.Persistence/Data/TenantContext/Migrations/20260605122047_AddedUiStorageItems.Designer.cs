...
namespace Triumph.HealthMs.Persistence.Data.TenantContext.Migrations
{
    ...
    [Migration("20260605122047_AddedUiStorageItems")]
    partial class AddedUiStorageItems
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Triumph.HealthMs.Core.Models.ApplicationUser.UiStorageItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("Key", "CreatedBy", "Deleted");

                    b.ToTable("UiStorageItems", (string)null);
                });
            ...
            modelBuilder.Entity("Triumph.HealthMs.Core.Models.Facilities.FacilityAnnouncement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "FacilityId", "Deleted", "Type", "CreatedAt");

                    b.ToTable("FacilityAnnouncements", (string)null);
                });
            ...
            modelBuilder.Entity("Triumph.HealthMs.Core.Models.Tenants.TenantAnnouncement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "Deleted", "Type", "CreatedAt");

                    b.ToTable("TenantAnnouncements", (string)null);
                });
            ...
            modelBuilder.Entity("Triumph.HealthMs.Core.Models.Facilities.FacilityAnnouncement", b =>
                {
                    b.HasOne("Triumph.HealthMs.Core.Models.Facilities.OrganizationalFacility", "OrganizationalFacility")
                        .WithMany("FacilityAnnouncements")
            ...
            modelBuilder.Entity("Triumph.HealthMs.Core.Models.Facilities.OrganizationalFacility", b =>
                {
                    b.Navigation("FacilityAnnouncements");
            ...
            modelBuilder.Entity("Triumph.HealthMs.Core.Models.Tenants.Tenant", b =>
                {
                    b.Navigation("TenantAnnouncements");
